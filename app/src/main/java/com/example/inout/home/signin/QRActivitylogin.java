...
public class QRActivitylogin extends AppCompatActivity {
    TextView  resultData;
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (intentIntegrator.getContents()!= null)
        {
            ...
            AlertDialog.Builder scan = new AlertDialog.Builder(QRActivitylogin.this);
            ...
            scan.setPositiveButton(R.string.thanks, (dialog, which) -> {
                settimeinfirebase();
                startActivity(new Intent(QRActivitylogin.this, MainActivity.class));
            });
    ...
    private void settimeinfirebase() {
        ...
        db.collection( "users" )
                ...
                .collection(Month)
                .add( data )
                .addOnSuccessListener(documentReference -> Toast.makeText( QRActivitylogin.this,  writtenwithTime, Toast.LENGTH_SHORT ).show())
                .addOnFailureListener(e -> Toast.makeText( QRActivitylogin.this, getString(ErroraddingTime)+ e, Toast.LENGTH_SHORT ).show());
    }
    private void scanner()
    {
        IntentIntegrator intentIntegrator = new IntentIntegrator(QRActivitylogin.this);
