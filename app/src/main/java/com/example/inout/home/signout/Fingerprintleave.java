...
public class Fingerprintleave extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_finger);      firebaseAuth = FirebaseAuth.getInstance();
        //assign variable
    ...
    private void finger() {
        ...
        Fingerprintleave activity = this;
        biometricPrompt.authenticate(new CancellationSignal(), executor, new BiometricPrompt.AuthenticationCallback() {
            @Override
            public void onAuthenticationSucceeded(BiometricPrompt.AuthenticationResult result) {
                {
                    activity.runOnUiThread(() -> {
                        AlertDialog.Builder scan = new AlertDialog.Builder(Fingerprintleave.this);
                        scan.setTitle(R.string.fingerprint);
                        scan.setMessage(R.string.authenticate);
                        scan.setPositiveButton(R.string.thanks, (dialog, which) -> startActivity(new Intent(Fingerprintleave.this, MainActivity.class)));
                        scan.create().show();
                        settimeinfirebase();
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if (requestCode == 100 && grantResults.length > 0 && (grantResults[0] + grantResults[1] == PackageManager.PERMISSION_GRANTED)) {
            ...
            //when permissions denied
            //display Toast
            Toast.makeText( Fingerprintleave.this, R.string.permissiondenied, Toast.LENGTH_SHORT ).show();
        }
    }
    ...
    private void settimeinfirebase() {
        ...
        db.collection( "users" )
                ...
                .collection(Month)
                .add( data )
                .addOnSuccessListener(documentReference -> Toast.makeText( Fingerprintleave.this, writtenwithTime, Toast.LENGTH_SHORT ).show())
                .addOnFailureListener(e -> Toast.makeText( Fingerprintleave.this, getString(ErroraddingTime) + e, Toast.LENGTH_SHORT ).show()
